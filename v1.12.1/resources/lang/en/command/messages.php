...
return [
    'location' => [
        'no_location_found' => 'Could not find a record matching the provided short code.',
        'ask_short' => 'Location Short Code',
        'ask_long' => 'Location Description',
        'created' => 'Successfully created a new location (:name) with ID :id.',
        'deleted' => 'Successfully deleted the requested location.',
    ],
    'user' => [
        'search_users' => 'Enter a username, user ID, or email address',
        'select_search_user' => 'ID of the user to delete (Enter \'0\' to search again)',
        'deleted' => 'User successfully deleted from the Panel.',
        'confirm_delete' => 'Are you sure you want to delete this user from the Panel?',
        'no_users_found' => 'No users found matching the provided search term.',
        'multiple_found' => 'Multiple accounts were found for the provided user, unable to delete a user because of the --no-interaction flag.',
        ...
        'ask_password_tip' => 'If you would like to create an account with a random password sent to the user via email, re-run this command (CTRL+C) and pass the `--no-password` flag.',
        'ask_password_help' => 'Passwords must be at least 8 characters long and contain at least one uppercase letter and a number.',
        '2fa_help_text' => [
            ...
            'If this is not what you intended to do, press CTRL+C to exit this process.',
        ],
    ...
    'server' => [
        ...
        'reinstall' => [
            'failed' => 'Reinstallation request for ":name" (#:id) on node ":node" failed with error: :message',
            'confirm' => 'You are about to execute a reinstallation against a group of servers. Do you wish to continue?',
        ],
        'power' => [
    ...
    'environment' => [
        'mail' => [
            ...
            'ask_mail_from' => 'Email address that emails should originate from',

...
return [
    'auth' => [
        ...
        'checkpoint' => '要求雙因素驗證',
        'recovery-token' => '已使用雙因素驗證備用碼',
        'token' => '已完成雙因素驗證',
        'ip-blocked' => '為 :identifier 封鎖來自未列出 IP 位址的請求',
        'sftp' => [
            'fail' => 'SFTP 登入失敗',
        ],
    ],
    'user' => [
        ...
        'ssh-key' => [
            'create' => '已向帳號新增 SSH 金鑰 :fingerprint',
            'delete' => '已從帳號移除 SSH 金鑰 :fingerprint',
        ],
        'two-factor' => [
            'create' => '已啟用雙因素驗證',
            'delete' => '已停用雙因素驗證',
    ...
    'server' => [
        ...
        'database' => [
            'create' => '已建立新資料庫 :name',
            'rotate-password' => '已為資料庫 :name 輪替密碼',
            'delete' => '已刪除資料庫 :name',
        ],
        'file' => [
        ...
        'allocation' => [
            ...
            'primary' => '已將 :allocation 設為主要伺服器分配',

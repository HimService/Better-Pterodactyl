...
return [
    'permissions' => [
        ...
        'control_console' => '允許使用者將資料傳送至伺服器主控台 (Console)。',
        ...
        'file_read' => '允許使用者檢視與此伺服器實例關聯的檔案和資料夾，以及檢視其內容。',
        'file_update' => '允許使用者更新與伺服器關聯的檔案和資料夾。',
        'file_delete' => '允許使用者刪除檔案和目錄。',
        'file_archive' => '允許使用者建立檔案封存 (壓縮) 並解壓縮現有的封存。',
        'file_sftp' => '允許使用者使用 SFTP 用戶端執行上述檔案動作。',
        'allocation_read' => '允許存取伺服器分配 (Allocation) 管理頁面。',

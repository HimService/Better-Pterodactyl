...
@section('title')
    @lang('admin/user.new.header')
@endsection

@section('content-header')
    <h1>@lang('admin/user.new.header')<small>@lang('admin/user.new.header_help')</small></h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.index') }}">@lang('admin/index.admin')</a></li>
        <li><a href="{{ route('admin.users') }}">@lang('admin/index.common.users')</a></li>
        <li class="active">@lang('strings.create')</li>
    </ol>
@endsection
...
<div class="row">
    <form method="post">
        <div class="col-md-6">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">@lang('admin/user.new.identity')</h3>
                </div>
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="username" class="control-label">@lang('strings.username')</label>
                        <div>
                            <input type="text" autocomplete="off" name="username" value="{{ old('username') }}" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="name_first" class="control-label">@lang('admin/user.index.client_name')</label>
                        <div>
                            <input type="text" autocomplete="off" name="name_first" value="{{ old('name_first') }}" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="name_last" class="control-label">@lang('admin/user.index.client_name')</label>
                        <div>
                ...
                <div class="box-footer">
                    {!! csrf_field() !!}
                    <input type="submit" value="@lang('admin/user.new.header')" class="btn btn-success btn-sm">
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">@lang('admin/user.new.permissions')</h3>
                </div>
                <div class="box-body">
        ...
        <div class="col-md-6">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">@lang('admin/user.new.password')</h3>
                </div>
                <div class="box-body">
                    <div class="alert alert-info">
                        <p>@lang('admin/user.new.password_help')</p>
                    </div>
                    <div id="gen_pass" class=" alert alert-success" style="display:none;margin-bottom: 10px;"></div>
                    <div class="form-group">
                        <label for="pass" class="control-label">@lang('admin/user.new.password')</label>
                        <div>
    ...
    <script>$("#gen_pass_bttn").click(function (event) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $("#gen_pass").html('<strong>@lang('admin/user.generated_password'):</strong> ' + data).slideDown();

...
@section('title')
    @lang('admin/mounts.index.title') &rarr; @lang('strings.view') &rarr; {{ $mount->id }}
@endsection
...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('admin.mounts') }}">@lang('admin/mounts.index.title')</a></li>
...
@section('content')
    <div class="row">
        <div class="col-sm-6">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">@lang('admin/mounts.view.details')</h3>
                </div>

                <form action="{{ route('admin.mounts.view', $mount->id) }}" method="POST">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="PUniqueID" class="form-label">@lang('admin/mounts.view.unique_id')</label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label class="form-label">@lang('admin/mounts.index.user_mountable')</label>
                    ...
                    <div class="box-footer">
                        ...
                        <button name="action" value="edit" class="btn btn-sm btn-primary pull-right">@lang('strings.save')</button>
        ...
        <div class="col-sm-6">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">@lang('admin/nests.eggs.eggs')</h3>
                    <div class="box-tools">
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addEggsModal">@lang('admin/mounts.view.add_eggs')</button>
                    </div>
                </div>
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">@lang('admin/mounts.index.nodes')</h3>
                    <div class="box-tools">
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addNodesModal">@lang('admin/mounts.view.add_nodes')</button>
                    </div>
                </div>
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover">
                        <tr>
                            <th>@lang('strings.id')</th>
                            <th>@lang('strings.name')</th>
                            <th>@lang('admin/node.index.fqdn')</th>
                            <th></th>
                        </tr>
            ...
            <div class="modal-content">
                <form action="{{ route('admin.mounts.eggs', $mount->id) }}" method="POST">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">@lang('admin/mounts.view.add_eggs')</h4>
                    </div>

                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="pEggs">@lang('admin/nests.eggs.eggs')</label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary btn-sm">@lang('strings.add')</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-content">
                <form action="{{ route('admin.mounts.nodes', $mount->id) }}" method="POST">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">@lang('admin/mounts.view.add_nodes')</h4>
                    </div>

                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="pNodes">@lang('admin/mounts.index.nodes')</label>
...
@section('footer-scripts')
    ...
    <script>
        $(document).ready(function() {
            $('#pEggs').select2({
                placeholder: '{{ trans('admin/mounts.view.select_eggs') }}',
            });

            $('#pNodes').select2({
                placeholder: '{{ trans('admin/mounts.view.select_nodes') }}',
            });
            ...
            $('button[data-action="detach-egg"]').click(function (event) {
                ...
                $.ajax({
                    ...
                    swal({ type: 'success', title: '{{ trans('admin/mounts.view.egg_detached') }}' });
                }).fail(function (jqXHR) {
                    console.error(jqXHR);
                    swal({
            ...
            $('button[data-action="detach-node"]').click(function (event) {
                ...
                $.ajax({
                    ...
                    element.parent().parent().addClass('warning').delay(100).fadeOut();
                    swal({ type: 'success', title: '{{ trans('admin/mounts.view.node_detached') }}' });
                }).fail(function (jqXHR) {
                    console.error(jqXHR);
                    swal({
                        title: '{{ trans('admin/api.index.whoops') }}',

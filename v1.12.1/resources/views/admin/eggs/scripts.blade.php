...
@section('title')
    @lang('admin/nests.index.title') &rarr; @lang('admin/nests.eggs.egg'): {{ $egg->name }} &rarr; @lang('admin/nests.eggs.install_script')
@endsection

@section('content-header')
    <h1>{{ $egg->name }}<small>@lang('admin/nests.eggs.install_script_description')</small></h1>
    <ol class="breadcrumb">
    ...
    <div class="col-xs-12">
        <div class="nav-tabs-custom nav-tabs-floating">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="{{ route('admin.nests.egg.scripts', $egg->id) }}">@lang('admin/nests.eggs.install_script')</a></li>
            </ul>
        </div>
    </div>
</div>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">@lang('admin/nests.eggs.install_script')</h3>
                </div>
                @if(! is_null($egg->copyFrom))
                    <div class="box-body">
                        <div class="callout callout-warning no-margin">
                            @lang('admin/nests.eggs.copy_script_warning', ['link' => route('admin.nests.egg.view', $egg->copyFrom->id), 'name' => $egg->copyFrom->name])
                        </div>
                    </div>
                @endif
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="form-group col-sm-4">
                            <label class="control-label">@lang('admin/nests.eggs.copy_script_from')</label>
                            ...
                            <p class="text-muted small">@lang('admin/nests.eggs.copy_script_help')</p>
                        </div>
                        <div class="form-group col-sm-4">
                            <label class="control-label">@lang('admin/nests.eggs.script_container')</label>
                            <input type="text" name="script_container" class="form-control" value="{{ $egg->script_container }}" />
                            <p class="text-muted small">@lang('admin/nests.eggs.script_container_help')</p>
                        </div>
                        <div class="form-group col-sm-4">
                            <label class="control-label">@lang('admin/nests.eggs.script_entrypoint')</label>
                            <input type="text" name="script_entry" class="form-control" value="{{ $egg->script_entry }}" />
                            <p class="text-muted small">@lang('admin/nests.eggs.script_entrypoint_help')</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 text-muted">
                            @lang('admin/nests.eggs.rely_on_script')

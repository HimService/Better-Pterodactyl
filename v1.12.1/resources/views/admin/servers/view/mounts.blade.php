...
@section('title')
    @lang('admin/server.tabs.about') — {{ $server->name }}: @lang('admin/server.tabs.mounts')
@endsection

@section('content-header')
    <h1>{{ $server->name }}<small>@lang('admin/server.mounts.header_help')</small></h1>
    <ol class="breadcrumb">
        ...
        <li class="active">@lang('admin/server.tabs.mounts')</li>
    </ol>
@endsection
        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">@lang('admin/server.mounts.available_mounts')</h3>
                </div>
                ...
                <div class="box-body table-responsible no-padding">
                    <table class="table table-hover">
                        <tr>
                            ...
                            <th>@lang('admin/mount.source')</th>
                            <th>@lang('admin/mount.target')</th>
                            ...
                            <tr>
                                ...
                                @if (! in_array($mount->id, $server->mounts->pluck('id')->toArray()))
                                    <td class="col-sm-2 middle">
                                        <span class="label label-primary">@lang('admin/server.mounts.unmounted')</span>
                                    </td>
                                ...
                                @else
                                    <td class="col-sm-2 middle">
                                        <span class="label label-success">@lang('admin/server.mounts.mounted')</span>
                                    </td>

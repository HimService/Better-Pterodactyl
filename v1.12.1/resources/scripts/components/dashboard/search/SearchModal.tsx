    ...
    return (
        <Formik
            ...
            validationSchema={object().shape({
                term: string().min(3, t('dashboard.search.search_validation', 'Please enter at least three characters to begin searching.')),
            })}
            ...
            {({ isSubmitting }) => (
                <Modal {...props}>
                    <Form>
                        <FormikFieldWrapper
                            name={'term'}
                            label={t('dashboard.search.search_term', 'Search term')}
                            description={t('dashboard.search.search_description', 'Enter a server name, uuid, or allocation to begin searching.')}
                        >
                            <SearchWatcher />

    ...
    return (
        <>
            <Dialog.Confirm
                ...
                title={`${t('global.delete', 'Delete')} ${file.isFile ? t('server.files.file', 'File') : t('server.files.directory', 'Directory')}`}
            ...
            <DropdownMenu
                ...
                renderToggle={(onClick) => (
                    <div css={tw`px-4 py-2 hover:text-neutral-900 dark:hover:text-white`} onClick={onClick}>

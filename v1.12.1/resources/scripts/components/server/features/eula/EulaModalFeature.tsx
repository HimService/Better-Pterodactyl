...
const EulaModalFeature = () => {
    ...
    return (
        ...
        >
            ...
            <h2 css={tw`text-2xl mb-4 text-neutral-100`}>{t('server.features.eula.title', 'Accept Minecraft® EULA')}</h2>
            <p css={tw`text-neutral-200`}>
                {t('server.features.eula.description_prefix', 'By pressing "I Accept" below you are indicating your agreement to the ')}&nbsp;
                <a
                    target={'_blank'}
                ...
                >
                    {t('server.features.eula.description_link', 'Minecraft® EULA')}
                </a>
                .
            </p>
            <div css={tw`mt-8 sm:flex items-center justify-end`}>
                ...
                <Button onClick={onAcceptEULA} css={tw`mt-4 sm:mt-0 sm:ml-4 w-full sm:w-auto`}>
                    {t('server.features.eula.accept_button', 'I Accept')}
                </Button>
            </div>
        </Modal>
    );

...
const SpinnerComponent = styled.div<Props>`
    ...
    border-color: ${(props) => (!props.isBlue ? 'rgba(var(--text-primary), 0.15)' : 'rgba(var(--color-brand-600), 0.2)')};
    border-top-color: ${(props) => (!props.isBlue ? 'rgb(var(--color-brand-500))' : 'rgb(var(--color-brand-600))')};
`;

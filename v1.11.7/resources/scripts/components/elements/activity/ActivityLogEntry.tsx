...
function wrapProperties(value: unknown): any {
    if (value === null || typeof value === 'string' || typeof value === 'number') {
        return `<strong class="font-semibold bg-transparent text-[var(--color-heading)]">${String(value)}</strong>`;
    }
...
export default ({ activity, children }: Props) => {
    ...
    return (
        <div
            className={
                'grid grid-cols-10 group rounded-lg p-4 mb-2 bg-[var(--color-card-bg)] border border-[var(--color-card-border)] shadow-[var(--color-shadow)]'
            }
        >
            ...
            <div className={'col-span-10 sm:col-span-9 flex'}>
                <div className={'flex-1 px-4 sm:px-0'}>
                    ...
                    <p className={classNames(style.description, 'dark:text-gray-200')}>

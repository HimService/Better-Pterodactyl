    ...
    return (
        <div className={classNames('flex items-center justify-between my-2', className)}>
            <p className={'text-sm text-neutral-500 dark:text-neutral-400'}>
                ...
                &nbsp;to&nbsp;
                <span className={'font-semibold text-neutral-600 dark:text-neutral-300'}>{end}</span> of&nbsp;
                <span className={'font-semibold text-neutral-600 dark:text-neutral-300'}>{pagination.total}</span> results.
            </p>
